...
RESUME_PROCESSING_CONCURRENCY = max(1, int(os.getenv("RESUME_PROCESSING_CONCURRENCY", "4")))
RANKING_CONCURRENCY = max(1, int(os.getenv("RANKING_CONCURRENCY", "4")))
QUESTIONNAIRE_CONCURRENCY = max(1, int(os.getenv("QUESTIONNAIRE_CONCURRENCY", "4")))
